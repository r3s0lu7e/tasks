                ...
                <div class="p-6">
                    <form method="POST" action="<?php echo e(route('projects.update', $project)); ?>" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="name" name="name" value="<?php echo e(old('name', $project->name)); ?>"
                                   required
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" id="key" name="key" value="<?php echo e(old('key', $project->key)); ?>"
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <option value="planning"
                                            <?php echo e(old('status', $project->status) == 'planning' ? 'selected' : ''); ?>>Planning
                                    </option>
                                    <option value="active"
                                            <?php echo e(old('status', $project->status) == 'active' ? 'selected' : ''); ?>>Active
                                    </option>
                                    <option value="on_hold"
                                            <?php echo e(old('status', $project->status) == 'on_hold' ? 'selected' : ''); ?>>On Hold
                                    </option>
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <option value="low"
                                            <?php echo e(old('priority', $project->priority) == 'low' ? 'selected' : ''); ?>>Low
                                    </option>
                                    <option value="medium"
                                            <?php echo e(old('priority', $project->priority) == 'medium' ? 'selected' : ''); ?>>Medium
                                    </option>
                                    <option value="high"
                                            <?php echo e(old('priority', $project->priority) == 'high' ? 'selected' : ''); ?>>High
                                    </option>
                                    <option value="critical"
                                            <?php echo e(old('priority', $project->priority) == 'critical' ? 'selected' : ''); ?>>
                                        Critical</option>
                                </select>
                        ...
                        <div>
                            ...
                            <div class="mt-1 flex items-center space-x-3">
                                <input type="color" id="color" name="color"
                                       value="<?php echo e(old('color', $project->color ?? '#3B82F6')); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <!-- Delete Form (Hidden) -->
                    <form id="delete-form" method="POST" action="<?php echo e(route('projects.destroy', $project)); ?>"
                          class="hidden">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\d\HomeProjects\tasksIveto\resources\views/projects/edit.blade.php ENDPATH**/ ?>