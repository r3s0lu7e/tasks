                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="text-lg font-medium text-gray-900">{{ $stats['today_tasks'] }}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-white overflow-hidden shadow rounded-lg">
                    <div class="px-4 py-5 sm:p-6">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <a href="{{ route('team.index') }}" class="text-sm text-blue-600 hover:text-blue-800">View
                                all</a>
                        </div>
                        <div class="space-y-3">
                            @forelse($teamMembers as $member)
                                <div
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-3">
                                            <h4 class="text-sm font-medium text-gray-900">
                                                <a href="{{ route('team.show', $member) }}" class="hover:text-blue-600">
                                                    {{ $member->name }}
                                                </a>
                                            </h4>
                                    ...
                                    <div class="text-right">
                                        <span
                                              class="text-sm font-medium text-gray-900">{{ $member->assigned_tasks_count }}</span>
                                ...
                                <div
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm text-gray-500">{{ $project->tasks->count() }} tasks •
                ...
                <div class="bg-white overflow-hidden shadow rounded-lg">
                    <div class="px-4 py-5 sm:p-6">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <a href="{{ route('tasks.index') }}" class="text-sm text-blue-600 hover:text-blue-800">View
                                all</a>
                        </div>
                        <div class="space-y-3">
