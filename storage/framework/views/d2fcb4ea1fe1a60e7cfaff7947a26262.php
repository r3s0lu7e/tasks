    ...
    <div class="min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div class="sm:mx-auto sm:w-full sm:max-w-md">
            <div class="text-center">
                <h1 class="text-4xl font-bold text-jira-blue mb-2"><?php echo e(config('app.name', 'Jira Clone')); ?></h1>
...
<?php /**PATH D:\d\HomeProjects\tasksIveto\resources\views/welcome.blade.php ENDPATH**/ ?>