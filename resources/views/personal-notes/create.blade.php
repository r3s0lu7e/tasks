    ...
    <div class="py-6">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="p-6 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-400">Add a new note to your personal scratchpad
                            </p>
                        </div>
            ...
            <div
                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('personal-notes.store') }}" class="space-y-6">
                        @csrf
                                ...
                                @foreach ($colorOptions as $colorValue => $colorName)
                                    <label class="flex items-center cursor-pointer color-option">
                                        <input type="radio" name="color" value="{{ $colorValue }}" class="sr-only"
                                               {{ old('color', '#fbbf24') === $colorValue ? 'checked' : '' }}>
