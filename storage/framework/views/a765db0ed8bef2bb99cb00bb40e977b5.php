    ...
    <div class="py-6">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="flex items-center justify-between">
                        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                            Edit Team Member: <?php echo e($team->name); ?>

                        </h2>
                        <a href="<?php echo e(route('team.show', $team)); ?>"
                ...
                <div class="p-6">
                    <form method="POST" action="<?php echo e(route('team.update', $team)); ?>" class="space-y-6">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" id="name" name="name" value="<?php echo e(old('name', $team->name)); ?>"
                                       required
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="email" id="email" name="email" value="<?php echo e(old('email', $team->email)); ?>"
                                       required
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="tel" id="phone" name="phone" value="<?php echo e(old('phone', $team->phone)); ?>"
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <option value="developer"
                                            <?php echo e(old('role', $team->role) == 'developer' ? 'selected' : ''); ?>>Developer
                                    </option>
                                    <option value="designer"
                                            <?php echo e(old('role', $team->role) == 'designer' ? 'selected' : ''); ?>>Designer
                                    </option>
                                    <option value="tester" <?php echo e(old('role', $team->role) == 'tester' ? 'selected' : ''); ?>>
                                        Tester
                                    </option>
                                    <option value="project_manager"
                                            <?php echo e(old('role', $team->role) == 'project_manager' ? 'selected' : ''); ?>>
                                        Project Manager</option>
                                    <option value="client" <?php echo e(old('role', $team->role) == 'client' ? 'selected' : ''); ?>>
                                        Client
                                    </option>
                                </select>
...
unset($__errorArgs, $__bag); ?>">
                                    <option value="active"
                                            <?php echo e(old('status', $team->status) == 'active' ? 'selected' : ''); ?>>Active
                                    </option>
                                    <option value="inactive"
                                            <?php echo e(old('status', $team->status) == 'inactive' ? 'selected' : ''); ?>>
                                        Inactive</option>
                                    <option value="vacation"
                                            <?php echo e(old('status', $team->status) == 'vacation' ? 'selected' : ''); ?>>On
                                        Vacation</option>
                                    <option value="busy" <?php echo e(old('status', $team->status) == 'busy' ? 'selected' : ''); ?>>
                                        Busy
                                    </option>
                                </select>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="number" id="hourly_rate" name="hourly_rate"
                                       value="<?php echo e(old('hourly_rate', $team->hourly_rate)); ?>" step="0.01" min="0"
                                       max="999.99"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="date" id="hire_date" name="hire_date"
                                       value="<?php echo e(old('hire_date', $team->hire_date ? $team->hire_date->format('Y-m-d') : '')); ?>"
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('notes', $team->notes)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <!-- Delete Button -->
                            <form method="POST" action="<?php echo e(route('team.destroy', $team)); ?>" class="inline-block"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\d\HomeProjects\tasksIveto\resources\views/team/edit.blade.php ENDPATH**/ ?>